...
| 游戏名称 | 是否可玩 | 备注 | 使用兼容层 |
| :-----: | :-----: | :-----: | :-----: |
| Apex 英雄 | ❌ | [厂商策略](https://x.com/PlayApex/status/1852019667315102151) | 未测试 |

## BattlEye（战眼）

| 游戏名称 | 是否可玩 | 备注 | 使用兼容层 |
| :-----: | :-----: | :-----: | :-----: |
| 彩虹六号：围攻 | ❌ | [厂商策略，仅单机模式](https://r6fix.ubi.com/projects/RAINBOW6-SIEGE-LIVE/issues/LIVE-57005) | 未测试 |
| 命运2 | ❌ | [厂商策略](https://www.gamingonlinux.com/2022/10/go-tell-bungie-you-want-destiny-2-on-steam-deck-linux/) | 未测试 |
| PUBG | ❌ | 厂商策略 | 未测试 |

# Vanguard（拳头）
| 游戏名称 | 是否可玩 | 备注 | 
| :-----: | :-----: | :-----: |
| 英雄联盟-国际服 | ❌ | 反作弊已切到无畏契约国际服同款 Vanguard | 未测试 |
| 无畏契约-国际服 | ❌ | Vanguard 内核级反作弊无法运行 | 未测试 |

# EA Anti-Cheat

## <center>别想了，EA可以司马了</center>
